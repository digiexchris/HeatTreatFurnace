...
#ifndef TEST_APP_MANUALOFF_HPP
#define TEST_APP_MANUALOFF_HPP
...
namespace HeatTreatFurnace::Furnace
{
    ...
    class ManualOffState: public BaseState, public etl::fsm_state
                     <FurnaceFsm, ManualOffState, STATE_MANUAL_OFF,
                      EvtModeOff, EvtModeProfile, EvtManualSetTemp, EvtManualSetOn, EvtError>
    {
    public:
        ...
        etl::fsm_state_id_t on_event(EvtManualSetOn const& anEvent);
